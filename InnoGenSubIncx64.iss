...
Name: InstallPython; Description: "Install python-3.9.10-amd64.exe"
Name: InstallRequest; Description: "Installs a python module required for the software to work"
...
Source: "0PREREQ\python-3.9.10-amd64.exe"; DestDir:"{tmp}"
...
Filename: "{tmp}\python-3.9.10-amd64.exe";    Tasks: InstallPython
